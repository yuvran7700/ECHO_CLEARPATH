...
# Contract test for GET /weather/preprocessed (Staging).
#
# Validates the response body against the ADAGE 3.0 Weather Record schema
...
from .schemas.weather_record_schema import WEATHER_RECORD_SCHEMA

load_dotenv()


def test_weather_preprocess_res_schema_match(weather_preprocessed_url):
    """
